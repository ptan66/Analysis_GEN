...
class WZEdmAnalyzer : public edm::EDAnalyzer {
 ...
 private:
  ...
  const Candidate *genLevelLeptonsPhotos( const Candidate *alevel, math::PtEtaPhiMLorentzVector &dressed, math::PtEtaPhiMLorentzVector &hardest_photon, double & ratio_dR01_04);
